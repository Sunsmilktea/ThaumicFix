	...
	public void updateEntity() {
		...
		if(getMRU() >=  500) {
			...
			try {
				...
				sparkle.invoke(proxy.get(null),xCoord+0.55F + MathUtils.randomFloat(worldObj.rand)/2F, yCoord+1F, zCoord+0.55F + MathUtils.randomFloat(worldObj.rand)/2F, 1F, 0, -0.2F);
