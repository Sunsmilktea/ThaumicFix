...
public class ETCfg implements IDummyConfig {
	...
	public void load(Configuration config) {
		...
		shouldUseMRUInStorage = config.getBoolean("shouldUseMRUInStorage", "MISCELLANEOUS", true, "Should wand foci in EssentialThaumaturgy use MRU stored in MRU storages?");
	}
}
